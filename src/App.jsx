...
function AppContent() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-900 font-sans antialiased flex flex-col justify-between">
      ...
      {!isAuthRoute && (
        <a
          href={`https://wa.me/${location.pathname === '/booking' ? (config?.whatsappNumber2 || '919309463714') : (config?.whatsappNumber || '918149814003')}`}
          target="_blank"
          rel="noreferrer"
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-2xl hover:bg-[#128C7E] transition-all duration-300 hover:scale-110 flex items-center justify-center animate-float"
